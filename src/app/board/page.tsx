  ...
  return (
    <div className="min-h-screen pt-40 pb-32 px-6 max-w-7xl mx-auto relative z-10 selection:bg-brand-neon">
      <div className="text-center mb-24 relative">
        ...
        <h1 className="text-6xl md:text-8xl font-black text-slate-900 dark:text-white tracking-tighter uppercase leading-[0.9] mb-8 relative z-10">
        ...
        <p className="text-xl text-slate-900 dark:text-white/60 max-w-2xl mx-auto font-light">
      ...
      <div className="space-y-8">
        {members.map((member, i) => (
          <motion.div 
            ...
            key={i} 
            className="glass-panel p-8 md:p-12 rounded-[2rem] border border-black/5 dark:border-black/5 dark:border-white/5 flex flex-col md:flex-row gap-8 md:gap-16 items-center md:items-start group hover:border-brand-neon/30 hover:shadow-glow transition-all duration-500"
          >
            <div className="w-full md:w-1/3 flex flex-col items-center md:items-start text-center md:text-left">
              <div className="w-48 h-48 bg-gray-50 dark:bg-gray-50 dark:bg-black/50 border border-brand-neon/20 rounded-2xl mb-6 relative overflow-hidden group-hover:border-brand-neon transition-colors">
              ...
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-1 group-hover:text-brand-neon transition-colors">{member.name}</h2>
              <span className="text-xs tracking-widest text-slate-900 dark:text-white/40 uppercase font-black">{member.role}</span>
            </div>
            
            <div className="w-full md:w-2/3 border-t md:border-t-0 md:border-l border-black/10 dark:border-black/10 dark:border-white/10 pt-8 md:pt-0 md:pl-16">
              ...
              <p className="text-lg text-slate-900 dark:text-white/80 leading-relaxed font-light">{member.bio}</p>
            </div>
          </motion.div>
        ))}
      </div>
