  ...
  return (
    <div className="bg-white dark:bg-white dark:bg-brand-black min-h-screen text-slate-900 dark:text-white font-sans pt-32 pb-24 selection:bg-blue-500/30">
      <div className="max-w-4xl mx-auto px-6 lg:px-12">
        <Link href="/" className="inline-flex items-center text-blue-400 hover:text-slate-900 dark:text-white font-mono text-sm uppercase tracking-widest mb-12 transition-colors">
          <ArrowLeft className="w-4 h-4 mr-2" /> Back to Intelligence Hub
        </Link>

        <div className="mb-12">
          <div className="flex gap-3 mb-6">
            <span className="bg-blue-500 text-slate-900 dark:text-white text-xs font-bold px-3 py-1 rounded-full uppercase font-mono">Cellular Energy</span>
            <span className="border border-white/20 text-slate-900 dark:text-white text-xs font-bold px-3 py-1 rounded-full uppercase font-mono flex items-center"><Database className="w-3 h-3 mr-1"/> Advanced Tier</span>
          </div>
        ...
        <div className="prose prose-invert prose-lg max-w-none prose-headings:font-black prose-headings:uppercase prose-headings:tracking-tighter prose-a:text-blue-400 prose-p:text-slate-900 dark:text-white/80 prose-li:text-slate-900 dark:text-white/80">
          ...
          <div className="bg-gray-50 dark:bg-gray-50 dark:bg-black/50 border border-blue-500/20 p-8 rounded-xl my-10">
