...
export default function QuizPage() {
  return (
    <div className="bg-gradient-animated min-h-screen pt-48 pb-24 text-brand-cream font-sans relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 drop-shadow-2xl">Bio-Age Diagnostics.</h1>
          <p className="text-xl text-brand-cream/60 max-w-2xl mx-auto font-light leading-relaxed">
