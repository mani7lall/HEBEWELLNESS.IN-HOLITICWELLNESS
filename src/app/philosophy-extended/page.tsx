...
export default function PhilosophyExtended() {
  return (
    <div className="bg-white dark:bg-white dark:bg-brand-black min-h-screen text-slate-900 dark:text-white font-sans pb-32">
      <nav className="p-8">
        <Link href="/" className="inline-flex items-center text-brand-neon hover:text-slate-900 dark:text-white transition-colors group">
      ...
      <main className="max-w-4xl mx-auto px-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-slate-900 dark:text-white/80 leading-relaxed mb-12 italic border-l-4 border-brand-neon pl-8 py-4 bg-brand-neon/5">
            ...
            <section className="mb-16">
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white uppercase tracking-tight flex items-center gap-3 mb-6">
            ...
            <div className="bg-brand-neon/10 border border-brand-neon/20 p-8 rounded-2xl mb-16">
               ...
               <p className="text-sm font-light text-slate-900 dark:text-white/70 leading-relaxed">
