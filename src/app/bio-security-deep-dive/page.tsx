  ...
  return (
    <div className="bg-brand-black min-h-screen text-brand-cream font-sans pb-32">
      ...
      <main className="max-w-6xl mx-auto px-6">
        <h1 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter mb-12">The <span className="text-brand-neon">Bio-Security Mandate</span></h1>
