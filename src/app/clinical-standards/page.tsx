    ...
    <div className="bg-brand-black min-h-screen text-brand-cream font-sans pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-16">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter mb-6">2026 Standards</h1>
          <p className="text-xl text-brand-cream/60 font-light border-l-4 border-brand-neon pl-6">Our rigorous requirement for data.</p>
        </div>
        ...
        <div className="prose prose-invert prose-lg max-w-none prose-p:text-brand-cream/80 prose-headings:font-bold prose-headings:text-white">
          <p>Welcome to the <strong>2026 Standards</strong> documentation. In 2026, transparency in health architecture is not a luxury; it is a requirement. The Hebe platform is built on the premise that you should have absolute control and understanding of your biological data.</p>
