  ...
  return (
    <div className="bg-brand-black min-h-screen text-brand-cream font-sans pb-32">
      ...
      <main className="max-w-4xl mx-auto px-6">
        <h1 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter mb-12">The <span className="text-brand-neon">Founder's Vision</span></h1>
        <div className="prose prose-invert prose-lg max-w-none">
          <p className="text-2xl text-brand-cream font-light mb-12 leading-relaxed">
          ...
          <div className="space-y-16">
            <section>
              <h2 className="text-3xl font-bold text-white uppercase tracking-tight mb-6">Democratizing Longevity</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold text-white uppercase tracking-tight mb-6">The Next Phase of Evolution</h2>
            ...
            <div className="bg-brand-neon/10 border border-brand-neon/20 p-8 rounded-2xl mb-16">
               ...
               <p className="text-sm font-light text-brand-cream/70 leading-relaxed italic">
