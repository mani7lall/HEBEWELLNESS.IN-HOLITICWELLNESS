        ...
        <div className="relative z-10 w-full flex flex-col items-center justify-center gap-8">
          ...
          <div className="mt-40 w-full max-w-sm glass-card p-10 rounded-[3rem] border border-rose-500/20 relative shadow-[0_0_50px_rgba(244,63,94,0.1)]">
            ...
            <div className="space-y-6 mb-10 text-left">
              <div>
                 <label className="text-xs uppercase tracking-widest text-brand-cream/60 font-bold block mb-2">Age (Years)</label>
              ...
              <div>
                 <label className="text-xs uppercase tracking-widest text-brand-cream/60 font-bold block mb-2">Resting Heart Rate (BPM)</label>
                 <div className="flex items-center gap-4">
                   ...
                   <span className="text-white font-mono font-bold w-8">{restingHr}</span>
                 </div>
              </div>
              <div>
                 <label className="text-xs uppercase tracking-widest text-brand-cream/60 font-bold block mb-2">Max Heart Rate (BPM)</label>
                 <div className="flex items-center gap-4">
                   ...
                   <span className="text-white font-mono font-bold w-8">{maxHr}</span>
                 </div>
              </div>
            </div>
            ...
            <button 
              onClick={calculate}
              className="w-full bg-rose-500 text-white font-black uppercase tracking-widest text-sm py-4 rounded-full hover:bg-white hover:text-black transition-all shadow-[0_0_20px_rgba(244,63,94,0.4)]"
            >
        ...
        <AnimatePresence mode="wait">
          {vo2 ? (
            <motion.div 
              ...
              exit={{ opacity: 0, x: -50 }}
              className="glass-card p-10 md:p-14 rounded-[3rem] border border-white/10 w-full relative overflow-hidden"
            >
              <div className="relative z-10">
                <span className="text-[10px] tracking-widest text-brand-cream/40 uppercase font-black block mb-4 border-b border-white/10 pb-4">Diagnostic Result</span>
                <span className="text-7xl font-black text-white block mb-2">{vo2}</span>
                <span className="text-xl text-brand-cream/70 font-light mb-10 block">mL/(kg·min)</span>
                ...
                <div className="mb-10 p-6 bg-black/40 rounded-2xl border border-white/5">
                  ...
                  <div className="text-lg text-white font-bold">{getPercentile(vo2)}</div>
                  <p className="text-sm text-brand-cream/50 mt-2 font-light">
                ...
                <div>
                  <span className="text-xs uppercase tracking-widest font-bold text-[#14B897] mb-6 block border-t border-white/10 pt-6">Hebe Cardiovascular Interventions</span>
                  <div className="space-y-4">
                     <Link href="/blog/methylene-blue-mitochondria" className="block bg-black/40 border border-white/5 hover:border-[#14B897]/50 p-4 rounded-2xl group transition-all">
                        ...
                        <p className="text-sm font-light text-brand-cream/50">Utilize Methylene Blue to drive systemic oxygen respiration efficiently.</p>
                      </Link>
                      <Link href="/protocols" className="block bg-black/40 border border-white/5 hover:border-[#14B897]/50 p-4 rounded-2xl group transition-all">
                        <h4 className="text-white font-bold mb-1 flex justify-between items-center">
                          Zone 2 Endurance Protocol
                          <span className="text-[9px] text-[#14B897] opacity-0 group-hover:opacity-100 transition-opacity uppercase tracking-widest">Execute <ArrowRight className="inline w-3 h-3"/></span>
                        </h4>
                        <p className="text-sm font-light text-brand-cream/50">Clinical cycling parameters designed to physically expand the left ventricle.</p>
                      </Link>
                  </div>
                </div>
             ...
             >
               ...
               <h3 className="text-2xl font-bold text-white mb-2">Awaiting Parameters</h3>
               <p className="text-brand-cream/50 font-light">Input your resting and maximum heart rates to immediately calculate your aerobic capacity and mortality percentile grouping.</p>
             </motion.div>
          )}
        </AnimatePresence>
      </div>
