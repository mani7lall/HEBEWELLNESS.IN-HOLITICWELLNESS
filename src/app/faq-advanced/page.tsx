    ...
    <div className="bg-white dark:bg-white dark:bg-brand-black min-h-screen text-slate-900 dark:text-white font-sans pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-16">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-slate-900 dark:text-white uppercase tracking-tighter mb-6">Advanced FAQ</h1>
          <p className="text-xl text-slate-900 dark:text-white/60 font-light border-l-4 border-brand-neon pl-6">Answers to complex protocol questions.</p>
        </div>
